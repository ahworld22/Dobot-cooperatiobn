...
def execute_gesture_command(gesture, movement_socket):
    ...
    gesture_sequences = {
        ...
        "one": [
            ...
            {"type": "move", "position": (252.2934, -234.5704, 223.9143, 171.5326, -0.4312, -108.5486), "wait": 0},#3
        ...
        "two": [
            ...
            {"type": "move", "position": (232.8893, -359.9239, 257.8296, 172.8682, -0.4384, -127.7273), "wait": 0},#7
            {"type": "tool", "command": "ToolDO", "index": 1, "status": 1, "wait": 2.0},
        ...
        "three": [
            ...
            {"type": "move", "position": (190.1676, -493.1779, 195.7462, 173.8494, -0.2792, -143.3572), "wait": 0}, #9
            {"type": "tool", "command": "ToolDO", "index": 1, "status": 1, "wait": 2.0},
            {"type": "move", "position": (239.7894, -448.8194, 378.3843, -177.6757, -0.4518, -135.7241), "wait": 0}, #8
            {"type": "move", "position": (150.7577, -535.1575, 529.3677, -172.4368, -0.4438, -149.5509), "wait": 2.0},#5
            {"type": "tool", "command": "ToolDO", "index": 1, "status": 0, "wait": 0.5},
        ...
        "six": [
            {"type": "move", "position": (183.8339, -133.3408, 605.9380, -172.0599, -0.3282, -87.4157), "wait": 0},  #1
            {"type": "move", "position": (239.7894, -448.8194, 378.3843, -177.6757, -0.4518, -135.7241), "wait": 0}, #8
            {"type": "move", "position": (262.1892, -470.9985, 189.2697, 179.1859, -0.2883, -135.6751), "wait": 0},  #10
            {"type": "tool", "command": "ToolDO", "index": 1, "status": 1, "wait": 2.0},
            {"type": "move", "position": (239.7894, -448.8194, 378.3843, -177.6757, -0.4518, -135.7241), "wait": 0},#8
            {"type": "move", "position": (150.7577, -535.1575, 529.3677, -172.4368, -0.4438, -149.5509), "wait": 2.0},#5
            {"type": "tool", "command": "ToolDO", "index": 1, "status": 0, "wait": 0.5},
        ...
        "gun": [
            {"type": "move", "position": (183.8339, -133.3408, 605.9380, -172.0599, -0.3282, -87.4157), "wait": 0},  #1
            {"type": "move", "position": (239.7894, -448.8194, 378.3843, -177.6757, -0.4518, -135.7241), "wait": 0}, #8
            {"type": "move", "position": (332.4647, -475.4962, 195.3145, -179.9835, -0.2912, -130.9234), "wait": 0}, #11
            {"type": "tool", "command": "ToolDO", "index": 1, "status": 1, "wait": 2.0},
            {"type": "move", "position": (239.7894, -448.8194, 378.3843, -177.6757, -0.4518, -135.7241), "wait": 0}, #8
            {"type": "move", "position": (150.7577, -535.1575, 529.3677, -172.4368, -0.4438, -149.5509), "wait": 2.0}, #5
            {"type": "tool", "command": "ToolDO", "index": 1, "status": 0, "wait": 0.5},
